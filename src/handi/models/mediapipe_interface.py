...
class MediapipeInterface(LandmarkPredictorInterface):
    ...
    @override
    def _process_results(self, result: HandLandmarkerResult, original_image: mp.Image, timestamp_ms: int) -> tuple[np.ndarray, TrackingResult]:
        ...
        for i in range(num_hands):
            ...
            if handedness == "Left" and lh is None:
                ...
                continue
        landmarks = TrackingResult(left_hand=lh, right_hand=rh, timestamp=timestamp_ms)
